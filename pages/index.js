    ...
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      text-sm text-gray-700">
        ...
        hover:bg-gray-100 cursor-pointer" />
          ...
          <Avatar url="https://wallpaperaccess.com/full/6783523.jpg" />
        </div>
      ...
      <form className="flex flex-col items-center mt-44 flex-grow w-4/5">
        ...
        focus-within:shadow-lg max-w-md rounded-full border-gray-200 px-5 py-3
        ...
        sm:flex-row sm:space-x-4">
          <button className="btn">Edward Search</button>

          <button className="btn">I'm Feeling Edward</button>
        </div>
      </form>
